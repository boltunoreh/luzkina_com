...
1. [Social Buttons Design](http://supsystic.com/plugins/social-share-plugin?utm_source=plugin&utm_medium=screenshotfirst&utm_campaign=socialbuttons "Social Buttons Design")

2. Social Share Buttons Admin Interface

3. [Social Share Buttons](http://supsystic.com/plugins/social-share-plugin?utm_source=plugin&utm_medium=screenshotsecond&utm_campaign=socialbuttons "Social Share Buttons") by Supsystic - admin interface. Where and when to show social buttons

4. Black and White Social Buttons
...
= 1.5.5 / 28.12.2015 =
* Fixed a bug with output of buttons in search list of posts
* Improved performance while maintaining of statistics views
* Fixed output of social networks list when adding new network to the list
...
* Fixed bug with date of project created
* Fixed bug with tooltips
* Buttons in content aligned to center
 ...
 * Fixed bug when user can't remove network from the project
 ...
 * Current version in incompatible with the Social Sharing Buttons PRO v1.0.2 and lower
 ...
 * New tooltips links
 * PopUp by Supsystic Plugins integration - https://wordpress.org/plugins/popup-by-supsystic/
 * Minor issues fix
 ...
 * Notice fixed
 * New share buttons design layout on settings tab
 * Social network buttons shares fixed
